/*
===============================================================================
DDL Script: Create Gold Views (Postgres)
===============================================================================
Purpose:
    - Final dimension and fact views (Star Schema)
    - Combines and cleans Silver layer data
...
LEFT JOIN gold.dim_products pr
    ON sd.sls_prd_key = pr.product_numbe_
