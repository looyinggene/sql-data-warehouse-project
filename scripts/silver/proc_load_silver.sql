...
BEGIN
    ...
    RAISE NOTICE '>> Load Duration crm_cust_info: % seconds', EXTRACT(EPOCH FROM (end_time - start_time));
    RAISE NOTICE '>> -------------';
    ...
    end_time := clock_timestamp();
    RAISE NOTICE '>> Load Duration crm_prd_info: % seconds', EXTRACT(EPOCH FROM (end_time - start_time));
    RAISE NOTICE '>> -------------';
    ...
    end_time := clock_timestamp();
    RAISE NOTICE '>> Load Duration crm_sales_details: % seconds', EXTRACT(EPOCH FROM (end_time - start_time));
    RAISE NOTICE '>> -------------';
    ...
    end_time := clock_timestamp();
    RAISE NOTICE '>> Load Duration erp_cust_az12: % seconds', EXTRACT(EPOCH FROM (end_time - start_time));
    RAISE NOTICE '>> -------------';
    ...
    end_time := clock_timestamp();
    RAISE NOTICE '>> Load Duration erp_loc_a101: % seconds', EXTRACT(EPOCH FROM (end_time - start_time));
    RAISE NOTICE '>> -------------';
    ...
    end_time := clock_timestamp();
    RAISE NOTICE '>> Load Duration erp_px_cat_g1v2: % seconds', EXTRACT(EPOCH FROM (end_time - start_time));
    RAISE NOTICE '>> -------------';
