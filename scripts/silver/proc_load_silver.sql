...
BEGIN
    ...
    SELECT
        ...
        END AS cst_gndr,
        cst_create_date,
        CURRENT_TIMESTAMP AS dwh_create_date   -- audit column
    FROM (
        SELECT
            *,
    ...
    SELECT
        ...
        SUBSTRING(prd_key FROM 7) AS prd_key,                          -- Extract product key (from 7th char to end)
        prd_nm,
    ...
    -- ================================================================
    -- Load Silver.crm_sales_details from Bronze.crm_sales_details
    -- ================================================================
